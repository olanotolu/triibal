...
_GOLD = "\033[1;38;2;185;255;209m"  # True-color #B9FFD1 bold
_BOLD = "\033[1m"
_DIM = "\033[2m"
_RST = "\033[0m"
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    """Build and print a welcome banner with Tribal mark on left and info on right.
    ...
    accent = _skin_color("banner_accent", "#8FFFA8")
    dim = _skin_color("banner_dim", "#5EA66B")
    text = _skin_color("banner_text", "#E8FFE9")
    ...
    try:
        ...
        _hero = _bskin.banner_hero if hasattr(_bskin, 'banner_hero') and _bskin.banner_hero else TRIBAL_MARK
    except Exception:
        _bskin = None
        _hero = TRIBAL_MARK
    left_lines = ["", _hero, ""]
    ...
    title_color = _skin_color("banner_title", "#B9FFD1")
    border_color = _skin_color("banner_border", "#7CFF9B")
