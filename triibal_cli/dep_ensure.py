...
def _has_triibal_agent_browser() -> bool:
    ...
    # install.sh installs globally into $TRIIBAL_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-TriibalHome", str(get_triibal_home()),
        ]
    else:
