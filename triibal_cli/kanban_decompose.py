...
Invoked by ``triibal kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Triibal Agent board.
...
def _profile_author() -> str:
    """Mirror of ``triibal_cli.kanban._profile_author``."""
    return (
