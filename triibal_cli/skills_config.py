"""
Skills configuration for Triibal Agent.
`triibal skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.triibal/config.yaml under:
...
from triibal_cli.config import cfg_get, load_config, save_config
from triibal_cli.colors import Colors, color
from triibal_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `triibal skills`."""
    from triibal_cli.curses_ui import curses_checklist
