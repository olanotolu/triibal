...
const sidebars: SidebarsConfig = {
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-triibal-agent',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-debugging-triibal-tui-commands',
                    'user-guide/skills/bundled/software-development/software-development-triibal-agent-skill-authoring',
                    'user-guide/skills/bundled/software-development/software-development-triibal-s6-container-supervision',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'guides/run-triibal-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-triibal',
        'guides/use-soul-with-triibal',
        'guides/use-voice-mode-with-triibal',
        'guides/build-a-triibal-plugin',
