...
Set your Tenor API key in your environment (add to `~/.triibal/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/Triibal/triibal/blob/main/skills/media/gif-search/url)`
