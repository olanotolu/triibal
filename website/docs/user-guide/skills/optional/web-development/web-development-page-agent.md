...
- User wants **Triibal itself to drive a browser** → use Triibal' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
