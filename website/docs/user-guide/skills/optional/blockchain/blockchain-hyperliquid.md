...
| | |
|---|---|
| Source | Optional — install with `triibal skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Triibal Agent |
| License | MIT |
...
The script reads `~/.triibal/.env` for two optional defaults:
...
Helper script: `~/.triibal/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.triibal/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.triibal/.env`.
...
```bash
python3 ~/.triibal/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.triibal/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
