...
| | |
|---|---|
| Source | Optional — install with `triibal skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Triibal Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $TRIIBAL_OSINT_CACHE/icij/ (default: ~/.cache/triibal-osint/icij/).
...
# Set TRIIBAL_OSINT_UA=your-app/1.0 (your@email) to identify yourself
