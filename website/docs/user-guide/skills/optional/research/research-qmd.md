...
| | |
|---|---|
| Source | Optional — install with `triibal skills install official/research/qmd` |
...
Triibal Agent via the native MCP client. This is the preferred
...
Then configure Triibal Agent to connect via HTTP:
