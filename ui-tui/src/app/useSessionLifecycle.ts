...
import type { ScrollBoxHandle } from '@triibal/ink'
import { evictInkCaches } from '@triibal/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.TRIIBAL_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
