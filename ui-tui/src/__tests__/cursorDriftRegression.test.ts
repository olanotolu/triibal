 ...
 *
 * Symptom: in `triibal --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@triibal/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using triibal --tui and as i type multiline my caret at the end will often ' +
