...
description: Use when a Triibal Kanban worker wants to run Codex CLI as an isolated implementation lane while Triibal keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
...
metadata:
  triibal:
    ...
    related_skills: [kanban-worker, codex, triibal-agent]
---
