...
required — uses aiohttp which is already a Triibal dependency.
...
def interactive_setup() -> None:
    ...
    ``triibal_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Triibal delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # triibal_cli/setup.py::_setup_mattermost function.
