# Triibal Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.triibal/plugins/triibal-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.triibal/plugins/triibal-achievements/scan_checkpoint.json`.
