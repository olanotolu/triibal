...
the get_anchored_view / get_messages_around primitives in triibal_state.
...
# Third-party integrations tag their sessions with TRIIBAL_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from triibal_state import DEFAULT_DB_PATH
