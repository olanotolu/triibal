...
const STORAGE_KEY = "triibal-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `triibal_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "triibal-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-triibal-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-triibal-theme-font", "true");
