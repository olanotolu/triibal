 ...
 * `window.__TRIIBAL_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Triibal brand in the top bar
 ...
 *  `window.__TRIIBAL_PLUGINS__.registerSlot(...)`.
 *
