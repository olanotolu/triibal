"""Tests for CodexEventProjector — codex item/* events → Triibal messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Triibal' message alternation invariant."""
