...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from triibal_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in TRIIBAL_OVERLAYS
        overlay = TRIIBAL_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify triibal doctor recognizes Xiaomi env vars."""
