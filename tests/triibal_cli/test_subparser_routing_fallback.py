...
The main() function in triibal_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `triibal -c model`
...
def _build_parser():
    """Build a minimal replica of the triibal top-level parser."""
