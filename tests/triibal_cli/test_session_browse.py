"""Tests for the interactive session browser (`triibal sessions browse`).
...
from triibal_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """triibal sessions browse should be parseable."""
        from triibal_cli.main import main as _main_entry
