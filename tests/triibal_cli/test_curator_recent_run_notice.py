...
The notice prints the most recent curator run summary on `triibal update`,
...
session start) so users normally never see the rename map. `triibal update`
