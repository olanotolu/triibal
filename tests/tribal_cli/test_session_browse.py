"""Tests for the interactive session browser (`tribal sessions browse`).
...
from tribal_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """tribal sessions browse should be parseable."""
        from tribal_cli.main import main as _main_entry
