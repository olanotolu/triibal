...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from tribal_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in TRIBAL_OVERLAYS
        overlay = TRIBAL_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify tribal doctor recognizes Xiaomi env vars."""
