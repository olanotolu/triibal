...
The main() function in tribal_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `tribal -c model`
...
def _build_parser():
    """Build a minimal replica of the tribal top-level parser."""
