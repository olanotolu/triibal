# Streaming LLM Response Support for Triibal Agent
...
```
TRIIBAL_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("TRIIBAL_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `triibal_cli/config.py` | 1 | +streaming config defaults |
...
TRIIBAL_STREAMING_ENABLED=true
```
