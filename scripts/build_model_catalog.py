#!/usr/bin/env python3
"""Build the Triibal Model Catalog — a centralized JSON manifest of curated models.
...
Triibal CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Triibal release.
...
# Ensure TRIIBAL_HOME is set for imports that touch it at module level.
os.environ.setdefault("TRIIBAL_HOME", os.path.join(os.path.expanduser("~"), ".triibal"))

from triibal_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "triibal-agent repo",
            "docs": "https://triibal.dev/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
