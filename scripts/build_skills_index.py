#!/usr/bin/env python3
"""Build the Triibal Skills Index — a centralized JSON catalog of all skills.
...
`triibal skills search/install` can use it without hitting the GitHub API.
...
# Ensure TRIIBAL_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Triibal Skills Index...", flush=True)
