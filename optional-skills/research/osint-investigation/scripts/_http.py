...
DEFAULT_UA = (
    "triibal-osint-investigation/0.2 "
    "(+https://github.com/Triibal/triibal; "
    "set TRIIBAL_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("TRIIBAL_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
